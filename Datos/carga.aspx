<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="carga.aspx.cs" Inherits="Datos.carga" %>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    <a href="carga.aspx"><i class="fa fa-upload"></i> <span class="nav-label">Carga Manual</span></a>
                </li>
                ...
                <div class="col-md-12">
                    <div class="ibox ">
                        <div class="ibox-title" style="height:100px;">
                            <h5>Enercon Dashboard 3.0 - Carga Manual</h5>
